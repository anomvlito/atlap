...
export interface Throw {
  ...
  mark: number; // metros
  discipline: string; // 'disco' | 'bala' | 'jabalina' | 'martillo'
  competition: string;
  location: string;
  source: ThrowSource;
  place?: number;
...
// Comienza vacío — el usuario agrega sus propias marcas
export const mockThrows: Throw[] = [];

// Dataset completo de Lucas Nervi — se importa solo cuando el usuario lo solicita
export const lucasNerviThrows: Throw[] = [
  // ── Local ───────────────────────────────────────────────────
  { id: 't1', date: '2019-08-10', mark: 54.14, discipline: 'disco', competition: 'TC AARM Escuela Militar', location: 'Escuela Militar, Santiago', source: 'local', place: 1 },
  { id: 't2', date: '2020-03-07', mark: 55.26, discipline: 'disco', competition: 'Meeting UC Apertura', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't3', date: '2021-03-12', mark: 58.79, discipline: 'disco', competition: 'Meeting UC 1º Top 10', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't4', date: '2021-03-19', mark: 58.94, discipline: 'disco', competition: 'Meeting UC 2º Top 10', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't5', date: '2021-05-14', mark: 59.55, discipline: 'disco', competition: 'Meeting UC 1º Top 3', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't6', date: '2021-08-07', mark: 58.95, discipline: 'disco', competition: "Copa O'Higgins Ejército", location: 'Escuela Militar, Santiago', source: 'local', place: 1 },
  { id: 't7', date: '2021-09-11', mark: 56.81, discipline: 'disco', competition: 'TC AARM Portuarios', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't8', date: '2021-09-14', mark: 60.22, discipline: 'disco', competition: 'Open UC Fiestas Patrias', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't9', date: '2021-09-25', mark: 59.8, discipline: 'disco', competition: 'MU20', location: 'San Carlos de Apoquindo, Santiago', source: 'local' },
  { id: 't10', date: '2021-10-02', mark: 60.14, discipline: 'disco', competition: 'Meeting Manquehue 1º Control Atlético', location: 'Club Deportivo Manquehue, Santiago', source: 'local', place: 1 },
  { id: 't11', date: '2021-10-09', mark: 61.27, discipline: 'disco', competition: 'Torneo Guillermo García Huidobro', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't12', date: '2021-11-12', mark: 58.77, discipline: 'disco', competition: 'Open UC Clausura', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't13', date: '2021-11-18', mark: 61.21, discipline: 'disco', competition: 'Campeonato Universitario', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't14', date: '2022-02-26', mark: 58.4, discipline: 'disco', competition: 'C. Nac. de Área Lanzamientos', location: 'Estadio Lucas Pacheco, Talagante', source: 'local', place: 1 },
  { id: 't15', date: '2022-03-16', mark: 62.49, discipline: 'disco', competition: 'Meeting UC Marzo', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't16', date: '2022-03-19', mark: 60.54, discipline: 'disco', competition: 'Meeting Manquehue 1º Todo Competidor', location: 'Club Deportivo Manquehue, Santiago', source: 'local', place: 1 },
  { id: 't17', date: '2022-03-26', mark: 59.27, discipline: 'disco', competition: 'TC AARM San Ignacio', location: 'Colegio San Ignacio El Bosque, Santiago', source: 'local', place: 1 },
  { id: 't18', date: '2022-04-02', mark: 64.55, discipline: 'disco', competition: 'Meeting Manquehue 2º Todo Competidor', location: 'Club Deportivo Manquehue, Santiago', source: 'local', place: 1, pb: true },
  { id: 't19', date: '2022-04-10', mark: 58.63, discipline: 'disco', competition: 'Camp. Nacional Adulto', location: 'Pista Atlética Lázaro Escobar, Temuco', source: 'local', place: 1 },
  { id: 't20', date: '2022-04-13', mark: 62.62, discipline: 'disco', competition: 'Meeting UC Abril', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't21', date: '2022-04-23', mark: 63.61, discipline: 'disco', competition: 'Torneo Mario Correa Letelier', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't22', date: '2022-04-30', mark: 61.69, discipline: 'disco', competition: 'TC AARM Carl Strutz', location: 'Club Deportivo Manquehue, Santiago', source: 'local', place: 1 },
  { id: 't23', date: '2022-05-07', mark: 58.17, discipline: 'disco', competition: 'GP Internacional Orlando Guaita', location: 'Pista Atlética Ramón Tapia, Copiapó', source: 'local', place: 2 },
  { id: 't24', date: '2022-05-14', mark: 60.15, discipline: 'disco', competition: 'Meeting UC Mayo', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't25', date: '2022-05-21', mark: 60.58, discipline: 'disco', competition: 'Iberoamericano Alicante', location: 'Alicante, España', source: 'local', place: 1 },
  { id: 't26', date: '2022-06-18', mark: 63.44, discipline: 'disco', competition: 'Meeting UC 2º Junio', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't27', date: '2022-06-25', mark: 62.77, discipline: 'disco', competition: 'Meeting CAS 1º Lanzamientos', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 1 },
  { id: 't28', date: '2023-03-18', mark: 61.27, discipline: 'disco', competition: 'TC AARM Nicolás Carvajal', location: 'Estadio Lucas Pacheco, Talagante', source: 'local', place: 1 },
  { id: 't29', date: '2023-03-25', mark: 60.51, discipline: 'disco', competition: 'TC AARM San Ignacio', location: 'Colegio San Ignacio El Bosque, Santiago', source: 'local', place: 1 },
  { id: 't30', date: '2023-04-01', mark: 62.7, discipline: 'disco', competition: 'Torneo Mario Correa Letelier', location: 'Club Deportivo Manquehue, Santiago', source: 'local', place: 1 },
  { id: 't31', date: '2023-04-15', mark: 59.92, discipline: 'disco', competition: 'TC AARM Carlos Strutz', location: 'Club Deportivo Manquehue, Santiago', source: 'local', place: 1 },
  { id: 't32', date: '2023-05-13', mark: 61.75, discipline: 'disco', competition: 'Meeting UC Mayo', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't33', date: '2023-05-19', mark: 60.98, discipline: 'disco', competition: 'GP Internacional Orlando Guaita', location: 'Pista Atlética Ramón Tapia, Copiapó', source: 'local', place: 1 },
  { id: 't34', date: '2023-05-27', mark: 60.82, discipline: 'disco', competition: 'Camp. Nacional Adulto', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't35', date: '2023-09-14', mark: 58.18, discipline: 'disco', competition: 'GP Internacional Primavera', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't36', date: '2023-09-30', mark: 60.05, discipline: 'disco', competition: 'Torneo Guillermo García Huidobro', location: 'Club Deportivo Manquehue, Santiago', source: 'local', place: 1 },
  { id: 't37', date: '2023-10-07', mark: 57.98, discipline: 'disco', competition: 'LDES 2° Fecha', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't38', date: '2023-10-15', mark: 61.72, discipline: 'disco', competition: 'TC AARM Lucy López', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't39', date: '2023-10-30', mark: 63.39, discipline: 'disco', competition: 'JJ Panamericanos Atletismo', location: 'Est. Nac. Julio Martínez Prádanos, Santiago', source: 'local', place: 1 },
  { id: 't40', date: '2024-03-23', mark: 59.55, discipline: 'disco', competition: 'Torneo Mario Correa Letelier', location: 'Colegio San Ignacio El Bosque, Santiago', source: 'local', place: 1 },
  { id: 't41', date: '2024-03-28', mark: 62.06, discipline: 'disco', competition: 'GP Internacional Santiago', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 1 },
  { id: 't42', date: '2024-03-31', mark: 61.38, discipline: 'disco', competition: 'Continental Tour - Bronze', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 1 },
  { id: 't43', date: '2024-04-06', mark: 62.0, discipline: 'disco', competition: 'Camp. Nacional Adulto', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 2 },
  { id: 't44', date: '2024-04-13', mark: 59.86, discipline: 'disco', competition: 'TC AARM Carl Strutz', location: 'Club Deportivo Manquehue, Santiago', source: 'local', place: 1 },
  { id: 't45', date: '2024-05-04', mark: 59.06, discipline: 'disco', competition: 'FENAUDE RM 1° Etapa', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 1 },
  { id: 't46', date: '2025-03-08', mark: 57.75, discipline: 'disco', competition: 'Meeting UC Apertura', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 2 },
  { id: 't47', date: '2025-03-15', mark: 56.83, discipline: 'disco', competition: 'Meeting UC Apertura Todo Competidor', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 2 },
  { id: 't48', date: '2025-03-22', mark: 59.44, discipline: 'disco', competition: 'Torneo Mario Correa Letelier', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 2 },
  { id: 't49', date: '2025-03-29', mark: 60.0, discipline: 'disco', competition: 'Camp. Nacional Adulto', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 2 },
  { id: 't50', date: '2025-05-02', mark: 59.04, discipline: 'disco', competition: 'GPX Sudamericano XLIII Orlando Guaita', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 3 },
  { id: 't51', date: '2025-05-04', mark: 59.19, discipline: 'disco', competition: 'Continental Tour Bronze Ciudad de Santiago', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 3 },
  { id: 't52', date: '2025-06-28', mark: 57.69, discipline: 'disco', competition: 'FENAUDE RM 1º Fecha', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 1 },
  { id: 't53', date: '2025-08-10', mark: 60.23, discipline: 'disco', competition: 'Meeting UC 1° Todo Competidor Agosto', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't54', date: '2025-08-16', mark: 57.63, discipline: 'disco', competition: 'Meeting UC 2° Todo Competidor Agosto', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't55', date: '2025-10-07', mark: 57.69, discipline: 'disco', competition: 'Campeonato Nacional FENAUDE', location: 'Est. Nac. Mario Recordón, Santiago', source: 'local', place: 1 },
  { id: 't56', date: '2025-10-12', mark: 61.93, discipline: 'disco', competition: 'Meeting UC Todo Competidor Octubre', location: 'San Carlos de Apoquindo, Santiago', source: 'local', place: 1 },
  { id: 't57', date: '2026-03-07', mark: 58.73, discipline: 'disco', competition: 'TC AARM Carlos Strutz', location: 'Club Deportivo Manquehue, Santiago', source: 'local', place: 1 },
  // ── Internacional ────────────────────────────────────────────
  { id: 't58', date: '2021-05-30', mark: 63.18, discipline: 'disco', competition: 'Campeonato Sudamericano de Mayores', location: 'Guayaquil, Ecuador', source: 'international', place: 1 },
  { id: 't59', date: '2021-10-17', mark: 60.87, discipline: 'disco', competition: 'Campeonato Sudamericano Sub 23', location: 'Guayaquil, Ecuador', source: 'international', place: 1 },
  { id: 't60', date: '2021-12-04', mark: 61.08, discipline: 'disco', competition: 'I Juegos Panamericanos Junior', location: 'Cali, Colombia', source: 'international', place: 1 },
  { id: 't61', date: '2023-07-29', mark: 59.64, discipline: 'disco', competition: 'Campeonato Sudamericano de Mayores', location: 'São Paulo, Brasil', source: 'international', place: 4 },
  { id: 't62', date: '2023-08-21', mark: 58.76, discipline: 'disco', competition: 'World Athletics Championships (Clasif.)', location: 'Budapest, Hungría', source: 'international', place: 32 },
  { id: 't63', date: '2025-06-22', mark: 59.14, discipline: 'disco', competition: 'G. Arzumanov Memorial (Cont. Tour Bronze)', location: 'Tashkent, Uzbekistán', source: 'international', place: 1 }
];
