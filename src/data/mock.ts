export interface TrainingSensations {
  ...
  stress: 1 | 2 | 3 | 4 | 5;
  sleep: 1 | 2 | 3 | 4 | 5;
  contextNotes?: string; // variables fantasma: exámenes, viajes, estrés extra-deportivo
}
...
export type HabitType = 'kine' | 'masaje' | 'crioterapia' | 'psicologia' | 'rutina_pre_comp' | 'sueño_registro';
...
export const mockCoach: Coach = {
  id: 'coach-001',
  name: 'Gera Morales',
  email: 'gera.morales@atletismochile.cl',
  specialties: ['velocidad', 'lanzamientos'],
  club: 'Club Atlético Santiago',
  avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=GeraCoach'
};

// ─── MOCK CICLOS DE ENTRENAMIENTO ────────────────────────────
export const mockTrainingCycles: TrainingCycle[] = [
  {
    id: 'cycle-001',
    athleteId: 'jp-001',
    coachId: 'coach-001',
    name: 'Base de Fuerza — Verano 2025',
    startDate: '2025-01-06',
    endDate: '2025-02-28',
    phase: 'fuerza',
    notes: 'Enfoque en desarrollo de fuerza máxima. Sin pesas en semana de competencia.'
  },
  {
    id: 'cycle-002',
    athleteId: 'jp-001',
    coachId: 'coach-001',
    name: 'Transición a Potencia — Otoño 2025',
    startDate: '2025-03-01',
    endDate: '2025-04-30',
    phase: 'potencia',
    notes: 'Reducción del trabajo láctico. Incorporar trabajo de potencia explosiva.'
  },
  {
    id: 'cycle-003',
    athleteId: 'jp-001',
    coachId: 'coach-001',
    name: 'Temporada de Competencias — Invierno 2025',
    startDate: '2025-05-01',
    endDate: '2025-08-31',
    phase: 'competencia',
    notes: 'Nacional en agosto. Mantener ritmo sin sobrecargar.'
  },
  {
    id: 'cycle-004',
    athleteId: 'jp-001',
    coachId: 'coach-001',
    name: 'Base de Fuerza — Verano 2026',
    startDate: '2026-01-05',
    endDate: '2026-06-30',
    phase: 'fuerza',
    notes: 'Ciclo actual. Preparación para temporada 2026.'
  }
];
